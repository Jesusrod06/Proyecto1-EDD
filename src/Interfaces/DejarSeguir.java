...
public class DejarSeguir extends javax.swing.JFrame {
    ...
    private void actualizarComboASeguir() {
        ...
        // Buscamos el vértice correspondiente en el grafo
        Vertice verticePrincipal = grafo.buscar(usuarioPrincipal);
        if (verticePrincipal == null) {
            return;
        }

        // Lista de adyacentes del usuario principal
        Lista adyacentes = verticePrincipal.getAdyacentes();

        // Rellenamos el combo con los nombres de los adyacentes
        for (int i = 0; i < adyacentes.getSize(); i++) {
            Vertice seguido = (Vertice) adyacentes.getValor(i);
            modeloCombo2.addElement(seguido.getNombre());
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dejar de Seguir");
        ...
        jLabel3.setText("Cuenta para dejar de seguir");
    ...
    private void seguirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seguirActionPerformed
        ...
        grafo.dejarDeSeguir(nombreUsuario1, nombreUsuario2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DejarSeguir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DejarSeguir().setVisible(true);
            }
        });
    }
